...
import { idlFactory } from './lolcoin_frontend.did.js';
export { idlFactory } from './lolcoin_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOLCOIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lolcoin_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lolcoin_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lolcoin_frontend.did.js")._SERVICE>}
 */
export const lolcoin_frontend = createActor(canisterId);
